...
export default function FeesPage() {
	...
	const rows = Object.entries(holdings).map(([sym, sh]) => {
	...
	return (
		<div className="space-y-6">
			...
			<p className="text-sm text-gray-600">Lower expense ratios directly boost long-term returns. Typical broad-market index funds charge 0.02%–0.10%.</p>
			...
			<p className="text-sm">Portfolio average expense ratio: {(weightedER * 100).toFixed(2)}%</p>
		</div>
	);
}